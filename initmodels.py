...
rating_one_one = Rating('Richard Dean Anderson', 1, 4)
rating_one_two = Rating('Sylvester Stallone', 1, 3)
rating_two_one = Rating('Sam Brown', 2, 4)
rating_two_two = Rating('Carrie Underwood', 2, 5)
rating_three_one = Rating('Richard Nixon', 3, 4)
rating_four_one = Rating('Bruce Willis', 4, 5)
rating_five_one = Rating('Cat Stevens', 5, 3)
rating_five_two = Rating('Sammy Davis Jr.', 5, 6)
rating_six_one = Rating('Zoidberg', 6, 5)
rating_seven_one = Rating('Harry Potter', 7, 5)
rating_seven_two = Rating('Chuck Norris', 7, 6)
rating_seven_three = Rating('Mr. Beaver', 7, 5)

db.session.add(rating_one_one)
db.session.add(rating_one_two)
db.session.add(rating_two_one)
db.session.add(rating_two_two)
db.session.add(rating_three_one)
db.session.add(rating_four_one)
db.session.add(rating_five_one)
db.session.add(rating_five_two)
db.session.add(rating_six_one)
db.session.add(rating_seven_one)
db.session.add(rating_seven_two)
db.session.add(rating_seven_three)
